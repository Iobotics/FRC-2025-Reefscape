        ...
        Commands.defer(
            () ->
                Commands.sequence(
                    ...
                    Commands.parallel(
                        new DriveToPose(
                            drive, () -> RobotState.getInstance().getSelectedSidePose(), 1, 4),
        ...
        Commands.defer(
            () ->
                Commands.sequence(
                    ...
                    Commands.parallel(
                        new DriveToPose(
                            drive, () -> RobotState.getInstance().getSelectedSidePose(1.32), 2, 5),
                        CoralCommands.raiseL3(elevator, arm)),
                    CoralCommands.releaseL3(elevator, arm, coralManipulator).withTimeout(0.5)),
            Set.of(drive, elevator, arm, coralManipulator));
    command.addRequirements(drive, elevator, arm, coralManipulator);
    return command;
  }
        ...
        Commands.defer(
            () ->
                Commands.sequence(
                    ...
                    CoralCommands.releaseL2(elevator, coralManipulator).withTimeout(0.5)),
            Set.of(drive, elevator, arm, coralManipulator));
    command.addRequirements(drive, elevator, arm, coralManipulator);
    return command;
  }
        ...
        Commands.defer(
            () ->
                Commands.sequence(
                    ...
                    new DriveToPose(
                        drive, () -> RobotState.getInstance().getSelectedSideAlgaePose(2), 2, 5),
                    Commands.parallel(
                        new DriveToPose(
                            drive,
                            () -> RobotState.getInstance().getSelectedSideAlgaePose(1.32),
                            2,
                            5),
